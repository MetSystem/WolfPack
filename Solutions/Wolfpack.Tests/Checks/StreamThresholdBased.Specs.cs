...
namespace Wolfpack.Tests.Checks
{
    ...
    public class StreamThresholdBasedSpecs : BddFeature
    {
        ...
        {
            using (var domain = new StreamingHealthCheckDomain(StreamingHealthCheckDomainConfig.FiresValues(1)))
            {
        ...
        {
            using (var domain = new StreamingHealthCheckDomain(StreamingHealthCheckDomainConfig.FiresValues(1,11)
                .ThresholdIs(10)))
            {
