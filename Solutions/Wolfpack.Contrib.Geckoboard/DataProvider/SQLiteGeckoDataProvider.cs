...
namespace Wolfpack.Contrib.Geckoboard.DataProvider
{
    ...
    {
        protected SQLiteGeckoDataProviderConfig _config;
        ...
        public SQLiteGeckoDataProvider()
        {
            ...
            _config = new SQLiteGeckoDataProviderConfig
                           {
        ...
        protected override AdhocCommandBase GetMapDataForCheckCommand(MapArgs args)
        {
            ...
            return SQLiteAdhocCommand.UsingSmartConnection(_config.ConnectionString)
